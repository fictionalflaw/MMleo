...
<div align="center">
  <img alt="LOGO" src="./logo.jpg" width="256" height="256" />
...
- 本软件 logo 并非使用 MIT 协议开源，[穹叶]()画师及软件全体开发者保留所有权利。不得以 MIT 协议已授权为由在未经授权的情况下使用本软件 logo，不得在未经授权的情况下将本软件 logo 用于任何商业用途。
